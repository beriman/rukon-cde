...
### Functional
- [ ] Project creation automatically generates `WIP_ARCH`, `WIP_STRUCT`, `WIP_MEP` folders.
- [ ] Users assigned to "Structure" role generally CANNOT view `WIP_ARCH` content.
- [ ] Users CAN view their own discipline's WIP.
- [ ] Admin/IM can view ALL WIP folders.

### Technical
- [ ] Extend `Folder` model or `Permission` logic to support "Discipline-Restricted" access.
- [ ] Middleware/Guard to check User Discipline vs Folder Discipline.
